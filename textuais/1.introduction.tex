...
According to \citeonline{Date:1990}, a \ac{db} can be defined as a collection of stored operational data used by the application systems of a given organization.
For \citeonline{Elmasri:2011}, a \ac{db} can be defined as an abstraction of the real world, also called a miniworld, since it represents aspects that, together, carry an implicit meaning.
...
This entire process can be classified as part of \ac{mde}, a software development approach in which models are the main input artifacts in the development process.
...
We have the premise that there is a growing search for instruments that support the teaching-learning process in academia.
