...
The contributions this work provides are listed below, including but not limited to:
...
\begin{enumerate} [label=\roman*.]
    \item The syntax and semantics definition for a conceptual modeling grammar for relational databases.
    \item The development of a tool that implements the grammar.
    ...
    \item Description of the application of quantitative analysis methods through hypothesis testing.
    \item Description of the application of qualitative analysis methods.
