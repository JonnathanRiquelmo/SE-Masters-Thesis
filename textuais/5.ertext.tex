...
% Este padrão de projeto preconiza que o algoritmo precisa modularizado em uma série de etapas, transformando essas etapas em métodos, e colocando uma série de chamadas para esses métodos dentro de um único método padrão. 
