...
\begin{figure}[!htb]
        \centering
        \caption{Effort (time) of treatments in \ac{ex2}.}
...
\begin{figure}[!htb]
        \centering
        \caption{F1 measure (quality) of treatments in \ac{ex2}.}
...
Levando em consideração que são abordagens que em sua essência são diametralmente opostas, acreditamos que os resultados similares observados pode ser um bom sinal.
Isso poderia indicar em um primeiro momento que nossa proposta alcançaria um nível similar de satisfação que o de outra ferramenta já madura e amplamente estabelecida.
Contudo, foi então feito outro experimento visando avaliar os geradores implementados, de uma forma mais qualitativa um vez que tinhamos um material estatísticamente relevante que suportam nossas conclusões em relação as hipóteses tratadas.
