...
However, despite the limitation imposed by an Eclipse plugin,\textit{ i.e.} works only locally, Xtext provides full \ac{lsp} support, which opens up the concrete possibility of future migration of our solution to a web platform capable of running directly in a browser.
