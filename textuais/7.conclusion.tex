...
However, despite the limitation imposed by an Eclipse plugin,\textit{ i.e.} works only locally, Xtext provides full \ac{lsp} support, which opens up the real possibility to the future migration of our solution to a web platform able to run directly in a browser.
